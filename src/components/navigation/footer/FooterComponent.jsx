			...
			<div className="container p-6 mx-auto">
					...
					<div className="w-full -mx-6 lg:w-2/5">
						<div className="px-6">
							...
							<div className="flex mt-6 -mx-2">
								<Link
									href="#"
									className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-yellow-500 dark:hover:text-yellow-400"
									aria-label="Reddit">
									<svg
				...
				<div>
					<p className="text-center text-gray-500 dark:text-gray-400">
						© FastShop 2023 - All rights reserved
					</p>
				</div>
			</div>
		</footer>
